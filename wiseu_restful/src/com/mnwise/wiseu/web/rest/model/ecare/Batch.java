...
public class Batch extends BaseVo {
    // 스케줄 요청에 대해 사용 가능한 필드
    protected String seq; //사용자 식별 키
    protected int ecareNo; //이케어 번호
    protected String resultSeq; //결과 순번
    protected String listSeq; //목록순번
    @NotBlank protected String channel; //발송 채널 구분 (MAIL: M, SMS: S, MMS/LMS: T, FAX: F, P:PUSH, A:알림톡, C:친구톡, B:브랜드톡)
