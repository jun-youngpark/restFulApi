...
/**
 * NVECARESENDLOG 테이블 모델 클래스
 */
public class EcareSendLogVo {
    private int ecareNo;
    ...
    private int subEcareNo;
    private int subResultSeq;
    ...
    public int getSubEcareNo() {
        return this.subEcareNo;
    }

    public void setSubEcareNo(int subEcareNo) {
        this.subEcareNo = subEcareNo;
    }

    public int getSubResultSeq() {
        return this.subResultSeq;
    }

    public void setSubResultSeq(int subResultSeq) {
        this.subResultSeq = subResultSeq;
    }
