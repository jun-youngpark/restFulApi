...
@Controller
public class WatchMtsController extends BaseController {
    private static final Logger log = LoggerFactory.getLogger(WatchMtsController.class);

    @Autowired private WatchService watchService;

    /**
     * - [wiseWatch>프로세스 탭] MTS 프로세스 상태 출력
     ...
     * @throws Exception
     */
    @RequestMapping("/watch/processStatus_mts.do")
