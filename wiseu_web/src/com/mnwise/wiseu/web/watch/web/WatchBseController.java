...
@Controller
public class WatchBseController extends BaseController {
    private static final Logger log = LoggerFactory.getLogger(WatchBseController.class);

    @Autowired private WatchService watchService;

    /**
     * - [wiseWatch>프로세스 탭] BSE 프로세스 상태 출력
     ...
     * @throws Exception
     */
    @RequestMapping("/watch/processStatus_bse.do")
