...
ALTER TABLE NVMOBILECONTENTS ALTER COLUMN CONTS_NM SET DATA TYPE VARCHAR(600);
...
-- 캠페인 친구톡 채널 컴럼 변경
ALTER TABLE NVECAREMSG ALTER COLUMN RELATION_TYPE SET DATA TYPE CHAR(1);
ALTER TABLE NVECAREMSG ALTER COLUMN RELATION_TYPE SET DEFAULT 'N';
