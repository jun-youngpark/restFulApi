-- 친구톡 템플릿코드 컬럼 사이즈 조정
ALTER TABLE MZFTSENDTRAN        MODIFY COLUMN TMPL_CD VARCHAR (30) NULL;
ALTER TABLE MZFTSENDLOG         MODIFY COLUMN TMPL_CD VARCHAR (30) NULL;

-- 친구톡 디폴트 설정 제거
ALTER TABLE MZFTSENDTRAN    MODIFY COLUMN SERVICE_TYPE    VARCHAR(2);
ALTER TABLE MZFTSENDTRAN    MODIFY COLUMN SERVICE_NO      NUMERIC(15);
