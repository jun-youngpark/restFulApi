ALTER TABLE nvdefaulthandler MODIFY handle_attr VARCHAR(10);
ALTER TABLE nvecaremultipartfile ADD file_type VARCHAR(10) NOT NULL;
...
ALTER TABLE nv_cd_mst MODIFY cd_cat VARCHAR(20) NOT NULL;
ALTER TABLE nv_cd_mst MODIFY par_cd_cat VARCHAR(20) NOT NULL;
