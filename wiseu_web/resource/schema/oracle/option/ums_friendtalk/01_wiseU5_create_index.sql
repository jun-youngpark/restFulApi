...
CREATE TABLE MZFTSENDTRAN (
  ...
  , SND_TYPE      VARCHAR2 (1   )  DEFAULT 'P'
  , PHONE_NUM     VARCHAR2 (16  )  NOT NULL
  , TMPL_CD       VARCHAR2 (30  )  NULL
  , SUBJECT       VARCHAR2 (40  )  NULL
  , SND_MSG       NVARCHAR2 (1000)  NOT NULL
  , SMS_SND_MSG   VARCHAR2 (2000  )  NULL
  , SMS_SND_NUM   VARCHAR2 (16  )  NULL
  , REQ_DEPT_CD   VARCHAR2 (50  )  DEFAULT 'admin'
  , REQ_USR_ID    VARCHAR2 (50  )  DEFAULT 'admin'
  , REQ_DTM       VARCHAR2 (14  )  NOT NULL
  , SND_DTM       VARCHAR2 (14  )  NULL
  , RSLT_CD       VARCHAR2 (4   )  NULL
  , RCPT_MSG      VARCHAR2 (250 )  NULL
  , RCPT_DTM      VARCHAR2 (14  )  NULL
  , SMS_SND_DTM   VARCHAR2 (14  )  NULL
  , SMS_RSLT_CD   VARCHAR2 (4   )  NULL
  , SMS_RCPT_MSG  VARCHAR2 (250 )  NULL
  , SMS_RCPT_DTM  VARCHAR2 (14  )  NULL
  , SMS_GB        VARCHAR2 (1   )  NULL
  , SMS_SND_YN    VARCHAR2 (1   )  DEFAULT 'N'
  , TRAN_SN       DECIMAL  (16,0)  NULL
  , TRAN_STS      VARCHAR2 (1   )  DEFAULT '1'
  , AGENT_ID      VARCHAR2 (20  )  NULL
  , SLOT1         VARCHAR2 (100 )  NULL
  , SLOT2         VARCHAR2 (100 )  NULL
  , TR_TYPE_CD    VARCHAR2 (1   )  DEFAULT '9'
  , USER_KEY      VARCHAR2 (30  )  NULL
  , MSG_GRP_CD    VARCHAR2 (30  )  NULL
  , AD_FLAG       VARCHAR2 (1   )  DEFAULT 'Y'
  , ATTACHMENT    VARCHAR2 (4000)  NULL
  , WIDE          VARCHAR2 (1   )  DEFAULT 'N'
  , APP_USER_ID   VARCHAR2 (20  )  NULL
...
CREATE TABLE MZFTSENDLOG (
  ...
  , SMS_RCPT_DTM  VARCHAR2 (14  )  NULL
  , SMS_GB        VARCHAR2 (1   )  NULL
  , SMS_SND_YN    VARCHAR2 (1   )  NULL
  , TRAN_SN       DECIMAL  (16,0)  NULL
  , TRAN_STS      VARCHAR2 (1   )  NOT NULL
  , AGENT_ID      VARCHAR2 (20  )  NULL
  , SLOT1         VARCHAR2 (100 )  NULL
  , SLOT2         VARCHAR2 (100 )  NULL
  , TR_TYPE_CD    VARCHAR2 (1   )  NULL
  , USER_KEY      VARCHAR2 (30  )  NULL
  , MSG_GRP_CD    VARCHAR2 (30  )  NULL
  , AD_FLAG       VARCHAR2 (1   )  NULL
  , ATTACHMENT    VARCHAR2 (4000)  NULL
  , WIDE          VARCHAR2 (1   )  NULL
  , APP_USER_ID   VARCHAR2 (20  )  NULL
  , LIST_SEQ                  VARCHAR2(10)        NOT NULL
  , CUSTOMER_KEY              VARCHAR2(50)        NOT NULL
  , SERVICE_NO               DECIMAL(15,0)         NOT NULL
...
ALTER TABLE MZFTSENDLOG		ADD IMAGE_PATH 		VARCHAR2(250);
