...
CREATE TABLE NVRESENDREQUEST (
    ...
    SERVICE_NO          NUMBER(15)          NOT NULL,
    SUPER_SEQ           NUMBER(16)          NOT NULL,
    RESULT_SEQ          NUMBER(16)                  ,
...
ALTER TABLE NVSERVERINFO          ADD(FAX_RESEND_ERROR_CD VARCHAR2(500));
ALTER TABLE NVSERVERINFO          ADD(SMS_RESEND_ERROR_CD VARCHAR2(500));
ALTER TABLE NVSERVERINFO          ADD(ALTALK_RESEND_ERROR_CD VARCHAR2(500));
...
-- 알림톡 사용 시
ALTER TABLE MZSENDTRAN  ADD LIST_SEQ        VARCHAR2(10);
ALTER TABLE MZSENDTRAN  ADD CUSTOMER_KEY    VARCHAR2(100);
ALTER TABLE MZSENDLOG   ADD LIST_SEQ        VARCHAR2(10);
ALTER TABLE MZSENDLOG   ADD CUSTOMER_KEY    VARCHAR2(100);
