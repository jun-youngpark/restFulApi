...
CREATE TABLE NVCAMPAIGN (
    ...
    CAMPAIGN_NM               VARCHAR2(100),
    CAMPAIGN_DESC             VARCHAR2(250),
    CAMPAIGN_PREFACE          VARCHAR2(250),
    CAMPAIGN_STS              CHAR(1),
    CREATE_DT                 CHAR(8),
    CREATE_TM                 CHAR(6),
    LASTUPDATE_DT             CHAR(8),
    ...
    CAMPAIGN_PREFACE_AB       VARCHAR2(250),
...
CREATE TABLE NV_SPAM_SENDLOG (
    ...
    RECORD_SEQ                VARCHAR2(10)        DEFAULT '0'    NOT NULL,
    SID                       VARCHAR2(5)         NOT NULL,
    SEND_DOMAIN               VARCHAR2(50)        NOT NULL
);
