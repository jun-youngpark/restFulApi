...
SELECT
    CONVERT(CHAR(8),TR_SENDDATE,112) AS TRAN_DATE, TR_RSLTSTAT AS TRAN_RSLT, SERVICE_TYPE, SERVICE_NO, RESULT_SEQ
FROM SC_LOG
WHERE TR_RSLTSTAT NOT IN ('06')
UNION ALL
SELECT
    CONVERT(CHAR(8),REQDATE,112) AS TRAN_DATE, RSLT AS TRAN_RSLT, SERVICE_TYPE, SERVICE_NO, RESULT_SEQ
FROM MMS_LOG
