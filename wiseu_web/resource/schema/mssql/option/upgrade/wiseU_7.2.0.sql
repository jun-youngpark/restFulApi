...
ALTER TABLE NVMOBILECONTENTS ALTER COLUMN CONTS_NM VARCHAR(600);
...
-- 캠페인 친구톡 채널 컴럼 변경
ALTER TABLE NVCAMPAIGN ALTER COLUMN CAMPAIGN_CLASS VARCHAR(10);

-- 친구톡 발송 mms 우회발송시 사용할 이미지경로
ALTER TABLE MZFTSENDTRAN ADD IMAGE_PATH VARCHAR(250);

-- 이케어 옴니채널 추가 컬럼
ALTER TABLE NVECAREMSG        ALTER COLUMN RELATION_TYPE CHAR(1);
ALTER TABLE NVECAREMSG        ADD CONSTRAINT DF_Constraint_ECARE_RELATION_TYPE DEFAULT 'N' FOR RELATION_TYPE;
