ALTER TABLE nvdefaulthandler ALTER COLUMN handle_attr VARCHAR(10);
ALTER TABLE nvecaremultipartfile ADD file_type VARCHAR(10) DEFAULT '' NOT NULL;
...
ALTER TABLE nv_cd_mst ALTER  COLUMN cd_cat VARCHAR(20) NOT NULL;
ALTER TABLE nv_cd_mst ALTER  COLUMN par_cd_cat VARCHAR(20) NOT NULL;
