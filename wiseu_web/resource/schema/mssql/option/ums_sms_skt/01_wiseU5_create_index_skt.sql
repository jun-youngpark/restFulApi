...
CREATE TABLE EM_TRAN (
    TRAN_PR         INT         NOT NULL IDENTITY(1,1),
    TRAN_REFKEY     VARCHAR(40),
    TRAN_ID         VARCHAR(20),
    TRAN_PHONE      VARCHAR(15) NOT NULL,
    TRAN_CALLBACK   VARCHAR(15),
...
CREATE TABLE EM_TRAN_MMS (
    MMS_SEQ         INT     NOT NULL IDENTITY(1,1),
...
ALTER TABLE EM_LOG     ADD SERVICE_NO      NUMERIC(15);
ALTER TABLE EM_LOG     ADD RESULT_SEQ      NUMERIC(16);
...
ALTER TABLE EM_TRAN    ADD SERVICE_NO      NUMERIC(15);
ALTER TABLE EM_TRAN    ADD RESULT_SEQ      NUMERIC(16);
