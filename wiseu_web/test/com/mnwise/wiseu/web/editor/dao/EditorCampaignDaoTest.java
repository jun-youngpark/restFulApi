 ...
 */
public class EditorCampaignDaoTest extends BaseDaoTestCase {

    protected String[] getConfigLocations() {
        return new String[] {
            "file:**/applicationContext-test.xml",
            // "file:**/conf/**/**-applicationContext.xml"};
            "file:**/conf/editor/editor-applicationContext.xml"
        };
    }

    public EditorCampaignDaoTest() {
    }

//    public EditorCampaignDaoTest(String runTest) {
//        super(runTest);
//    }
...
//
//        suite.addTest(new EditorCampaignDaoTest("testUpdateEditorCampaign"));
//        suite.addTest(new EditorCampaignDaoTest("testUpdateEditorCampaignHandler"));
//        suite.addTest(new EditorCampaignDaoTest("testUpdateEditorCampaignTemplate"));
//        suite.addTest(new EditorCampaignDaoTest("testDeleteEditorCampaignLinktrace"));
//        suite.addTest(new EditorCampaignDaoTest("testUpdateEditorCampaignLinktrace"));
//
//        return suite;
//    }
