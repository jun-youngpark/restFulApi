                ...
                <div class="table-responsive gridWrap">
                    <table class="table table-sm dataTable table-fixed">
                        ...
                        <tr>
                            ...
                            <td><em class="txt_channel s">S</em> <span>${scenarioVo.campaignVo.campaignNo}</span></td>
                        </tr>
                        <tr>
                            <th scope="row">
                                <em class="required">required</em><spring:message code="campaign.menu.sfax"/><!-- 발신자 번호 -->
                            </th>
