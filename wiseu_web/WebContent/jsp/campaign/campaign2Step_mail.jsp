...
<script type="text/javascript">
    ...
    var rules = {
        "campaignVo.senderEmail"     : {email : true, maxlength: 50, notBlank : true},
        "campaignVo.senderNm"        : {notBlank : true, maxlength: 50},
        "campaignVo.retmailReceiver" : {email : true, maxlength: 50, notBlank : true},
        "campaignVo.retryCnt"        : {notBlank : true, digits : true},
        segmentSize                  : {min : 1},
    ...
    function initEventBind() {
        ...
        $('#previewBtn').on("click", function(event) {
            ...
            // /common/mime_view.do
            var url = "/common/previewMainPopup.do?cmd=previewList&serviceNo=${scenarioVo.campaignVo.campaignNo}&serviceType=EM&abTestType=${scenarioVo.abTestType}";
            $.mdf.popupGet(url, 'previewPopup', 1000, 1000);
        });
        ...
        $('#saveBtn').on("click", function(event) {
            ...
            if(${scenarioVo.campaignVo.campaignSts eq 'V'} === true || ${scenarioVo.campaignVo.editAble} === false) {
...
<div class="main-panel">
    <div class="container-fluid mt-4 mb-2"><!-- Page content -->
        <div class="card">
            ...
            <div class="card-body pb-0">
                <div class="row align-items-center py-1 table_option">
                    <div class="col-9"><!-- buttons -->
                        <button type="button" class="btn btn-sm btn-outline-primary" id="linkCheckBtn">
                ...
                <div class="table-responsive gridWrap">
                    <table class="table table-sm dataTable table-fixed">
                        ...
                        <tr>
                            ...
                            <td><em class="txt_channel M">E</em> <span>${scenarioVo.campaignVo.campaignNo}</span></td>
                        </tr>
                        <tr>
                            <th scope="row"><em class="required">required</em><spring:message code="campaign.menu.semail"/></th><!-- 발신자 이메일 -->
                            <td><form:input path="campaignVo.senderEmail" cssClass="form-control form-control-sm w-75" /></td>
                            <th scope="row"><em class="required">required</em><spring:message code="campaign.menu.sname"/></th><!-- 발신자명 -->
                            <td><form:input path="campaignVo.senderNm" cssClass="form-control form-control-sm w-75" /></td>
                        </tr>
                        <tr>
                            <th scope="row"><em class="required">required</em><spring:message code="common.menu.returnmail"/></th><!-- 반송 이메일 -->
                            <td><form:input path="campaignVo.retmailReceiver" cssClass="form-control form-control-sm w-75" /></td>
                            <th scope="row"><em class="required">required</em><spring:message code="campaign.menu.je" /></th><!-- 재반복 횟수 -->
                            <td>
                                <div class="form-inline input-has-unit">
                                    <form:input path="campaignVo.retryCnt" maxlength="2" cssClass="form-control form-control-sm w-25"/>
                                    <span class="unit"><spring:message code="campaign.menu.times"/></span>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <th scope="row"><!-- 수신확인 -->
                                <spring:message code="campaign.menu.susin"/>
                            </th>
                            <td colspan="3">
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <form:checkbox path="campaignVo.campaignType" id="recev_chk" value="Y" cssClass="custom-control-input" />
                                    <label class="custom-control-label" for="recev_chk"></label>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="card-body py-0"><!-- 제목, 에디터 -->
                <iframe id="editorIfrm" name="editorIfrm" scrolling="no"
                    src="/editor/editor.do?type=campaign&campaignNo=${scenarioVo.campaignVo.campaignNo}&segmentNo=${scenarioVo.segmentNo}&handlerType=${scenarioVo.handlerType}&channelType=${scenarioVo.campaignVo.channelType}&useMultiLang=${useMultiLang}&abTestType=${scenarioVo.abTestType}"
                ></iframe>
            </div>

            <div class="card-footer my-0 btn_area"><!-- button area -->
                <div class="row">
