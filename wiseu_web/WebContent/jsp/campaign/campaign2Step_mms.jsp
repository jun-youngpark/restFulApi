...
<script type="text/javascript">
    ...
    var rules = {
        ...
        "campaignVo.senderNm" : {maxlength: 50}
    };
...
<body>
<form:form commandName="scenarioVo" action="/campaign/campaign2Step.do" id="editorFrm" name="editorFrm" method="post"><!-- /campaign/campaign_2step_form.do -->
...
<div class="main-panel">
    <div class="container-fluid mt-4 mb-2"><!-- Page content -->
        <div class="card">
                ...
                <div class="table-responsive gridWrap">
                    <table class="table table-sm dataTable table-fixed">
                        ...
                        <tr>
                            ...
                            <td><em class="txt_channel t">M</em> <span>${scenarioVo.campaignVo.campaignNo}</span></td>
                        </tr>
                        <tr>
                            <th scope="row"><!-- 발신자 번호 -->
                                <em class="required">required</em><spring:message code="campaign.menu.sfax"/>
                            </th>
                            <td><form:input path="campaignVo.senderTel" cssClass="form-control form-control-sm w-50"/></td>
                            <th scope="row"><spring:message code="campaign.menu.sname"/></th><!-- 발신자명 -->
            ...
            <div class="card-body message_contents pt-0"><!-- message -->
