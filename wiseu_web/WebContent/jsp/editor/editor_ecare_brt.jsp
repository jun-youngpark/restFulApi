...
<script type="text/javascript">
    ...
    function editorSave(allSave){
        ...
        param.templateVos= makeKkoTemplate(ecareNo, template, " ", param.kakaoSenderKey, param.kakaoTmplCd);  //템플릿
...
<form id="editorFrm" name="editorFrm" method="post">
    ...
    <input type="hidden" id="kakaoTmplCd" name="kakaoTmplCd"  value="${ecareScenarioVo.ecareVo.kakaoTmplCd}"/>
    <input type="hidden" id="kakaoSenderKey" name="kakaoSenderKey"  value="${ecareScenarioVo.ecareVo.kakaoSenderKey}"/>
    <input type="hidden" id="kakaoImageNo" name="kakaoImageNo" value="${ecareScenarioVo.ecareVo.kakaoImageNo}"/>
        ...
        <div class="col-3 col-phone"><!-- mobile preview -->
         ...
         <div class="col-9"><!-- message list -->
            <div class="table-responsive gridWrap">
                  <table id="kakao_button_table" class="table table-sm dataTable">
                         <colgroup>
                             <col width="10%" />
                             <col width="10%" />
                             <col width="*" /><!-- 버튼명 -->
...
<form name="brtContentsFrm" id="brtContentsFrm" method="post"><!-- /editor/altalk_contents_list.do -->
