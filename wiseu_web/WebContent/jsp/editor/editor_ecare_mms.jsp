...
<div class="card-body px-3">
    ...
    <div class="table-responsive gridWrap">
        <table class="table table-sm dataTable">
            <tr>
                <th scope="row" width="110"><spring:message code="ecare.menu.subject" /></th>
        ...
        <div class="col-9"><!-- message list -->
            <ul class="nav nav-tabs tab01"><!-- tab -->
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" id="image-tab" data-toggle="tab" href="#templateTab" role="tab" aria-controls="image" aria-selected="true"><spring:message code="editor.image"/><!-- 이미지 --></a>
                </li>
                <li class="nav-item">
...
<form name="mmsContentsFrm" id="mmsContentsFrm" action="/editor/mmsContsList.do" method="post"><!-- /editor/mms_contents_list.do -->
    <input type="hidden" name="fileType" value="T">
    <input type="hidden" name="contsTxt">
    <input type="hidden" name="countPerPage" value="6">
</form>
<form name="mmsImageFrm" id="mmsImageFrm"  action="/editor/mmsContsList.do" method="post"><!-- /editor/mms_contents_list.do -->
