	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/images/ajax/plugin/progressbar.gif',		// boxImage : image around the progress bar
				barImage	: '/images/ajax/plugin/progressbg_green.gif',	// Image to use in the progressbar. Can be an array of images too.
